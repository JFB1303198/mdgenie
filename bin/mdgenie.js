...
\`\`\`bash
git clone https://github.com/${answers.githubUsername || 'your-username'}/${answers.projectTitle.toLowerCase().replace(/\s+/g, '-')}.git
\`\`\`\n\n`;
}
...
*Generated by [MDGenie](https://github.com/your-username/mdgenie) - Your README Generator*
`;
}
